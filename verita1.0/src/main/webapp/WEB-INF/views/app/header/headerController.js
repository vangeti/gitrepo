mainApp.controller('headerController', function($scope, $location,
	...
	/*
	 * $scope.selectedStyle = ''; $scope.stylePath = 'style.css'; $scope.names = [
	 * "style", "style1" ];
	 */
	...
	$scope.userImg = 'views/images/users/rajesh.jpg';
	...
	if ($sessionStorage.username == undefined) {
		...
		/*if ($scope.username === 'Cigniticio') {
			$scope.userImg = 'views/images/users/userpic_cigniticio.png';
		} else if ($scope.username === 'Cignitiperf') {
			$scope.userImg = 'views/images/users/userpic_cignitiperf.jpg';
		} else if ($scope.username === 'Cignitiscrum') {
			$scope.userImg = 'views/images/users/userpic_cigniticio.jpg';
		}*/
