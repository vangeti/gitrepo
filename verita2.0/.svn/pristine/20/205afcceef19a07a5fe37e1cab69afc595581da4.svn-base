mainApp.controller('TestController', function($scope, $sessionStorage, $rootScope,$http, widgetService) {
	
	$scope.tdTitle = 'Test Lennox';
	...
	$('.testPanel').on('onPin.lobiPanel', function(ev, lobiPanel){
	...
	$('.testPanel').on('onUnpin.lobiPanel', function(ev, lobiPanel){
	...
	$('.testPanel').on('beforeClose.lobiPanel', function(ev, lobiPanel) {
